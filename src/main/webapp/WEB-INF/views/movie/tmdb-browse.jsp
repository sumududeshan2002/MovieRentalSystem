...
<main class="container py-4">
    ...
    <form action="${pageContext.request.contextPath}/movies/tmdb/search" method="get" class="mb-4">
        <div class="input-group">
            <input type="text" name="query" class="form-control" placeholder="Search TMDB movies">
    ...
    <c:choose>
        <c:when test="${empty tmdbMovies}">
            <div class="alert alert-secondary mb-0">No movies available from TMDB right now.</div>
        </c:when>
        <c:otherwise>
            <div class="row g-4">
