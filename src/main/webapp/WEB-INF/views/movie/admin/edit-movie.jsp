    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="bg-white border rounded p-4">
                ...
                <form action="${pageContext.request.contextPath}/movies/admin/edit/${movie.movieId}" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="title" type="text" name="title" class="form-control" value="${movie.title}" required>
                    </div>
                    <div class="mb-3">
                        <label for="genre" class="form-label">Genre</label>
                        <input id="genre" type="text" name="genre" class="form-control" value="${movie.genre}" required>
                    </div>
                    <div class="mb-3">
                        <label for="director" class="form-label">Director</label>
                        <input id="director" type="text" name="director" class="form-control" value="${movie.director}" required>
                    </div>
                    <div class="mb-3">
                        <label for="year" class="form-label">Year</label>
                        <input id="year" type="number" name="year" class="form-control" value="${movie.year}" required>
                    </div>
